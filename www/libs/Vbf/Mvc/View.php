...
class Vbf_Mvc_View
{
  ...
  public function __isset($var) {
    return isset($this->parameters) && array_key_exists($var, $this->parameters);
  }
  ...
  public function getCurrentUri() {
    return $this->frontController->getCurrentUri();
  }
  
  public function getCurrentResourceUri() {
    return $this->frontController->getCurrentResourceUri();
  }
  
  public function getCurrentModuleUri() {
    return $this->frontController->getCurrentModuleUri();
  }
