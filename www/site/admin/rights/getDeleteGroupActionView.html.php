...
<div class="content_list">
  <form id="formRight" name="formRight" method="post" action="<?php echo $this->createUriFromModule($this->right_id . '/' . $this->group_id . '/deleteGroup?_method=POST'); ?>">
    <input type="hidden" name="from_html" value="true" />
    <h4>Êtes vous sûr de vouloir supprimer ce droit de ce groupe ?</h4>
